...
# define Rte_InitValue_PpSpeedometerValueIn_DeSpeedometerValue (0U)
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_CtApAFSController_PpAmbientLightBrightnessIn_DeAmbientLightBrightness(P2VAR(IdtDioValueType, AUTOMATIC, RTE_CTAPAFSCONTROLLER_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_CtApAFSController_PpSpeedometerValueIn_DeSpeedometerValue(P2VAR(IdtDioValueType, AUTOMATIC, RTE_CTAPAFSCONTROLLER_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *********************************************************************************************************************/
# define Rte_Read_PpAmbientLightBrightnessIn_DeAmbientLightBrightness Rte_Read_CtApAFSController_PpAmbientLightBrightnessIn_DeAmbientLightBrightness
# define Rte_Read_PpSpeedometerValueIn_DeSpeedometerValue Rte_Read_CtApAFSController_PpSpeedometerValueIn_DeSpeedometerValue
...
# define RTE_RUNNABLE_RCtApLowBatteryLogic RCtApLowBatteryLogic
