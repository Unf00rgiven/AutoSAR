...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: RCtCddIoHwAb_PpBatteryManager_BatteryLevel
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ReadChannel> of PortPrototype <PpBatterLevel>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   void RCtCddIoHwAb_PpBatteryManager_BatteryLevel(uint8 *value)
 *
 *********************************************************************************************************************/

# define RTE_RUNNABLE_RCtCddIoHwAb_PpBatteryManager_BatteryLevel RCtCddIoHwAb_PpBatteryManager_BatteryLevel
FUNC(void, CtCddIoHwAb_CODE) RCtCddIoHwAb_PpBatteryManager_BatteryLevel(P2VAR(uint8, AUTOMATIC, RTE_CTCDDIOHWAB_APPL_VAR) value); /* PRQA S 0850 */ /* MD_MSR_19.8 */
