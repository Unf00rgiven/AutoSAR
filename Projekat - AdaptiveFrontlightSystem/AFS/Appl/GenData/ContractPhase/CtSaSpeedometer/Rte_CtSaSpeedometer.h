...
# define Rte_InitValue_PpSpeedometerValueOut_DeSpeedometerValue (0U)
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_CtSaSpeedometer_PpSpeedometerValueIn_DeSpeedometerValue(P2VAR(IdtDioValueType, AUTOMATIC, RTE_CTSASPEEDOMETER_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtSaSpeedometer_PpSpeedometerValueOut_DeSpeedometerValue(IdtDioValueType data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 *********************************************************************************************************************/
# define Rte_Read_PpSpeedometerValueIn_DeSpeedometerValue Rte_Read_CtSaSpeedometer_PpSpeedometerValueIn_DeSpeedometerValue


/**********************************************************************************************************************
 * Rte_Write_<p>_<d> (explicit S/R communication with isQueued = false)
 *********************************************************************************************************************/
# define Rte_Write_PpSpeedometerValueOut_DeSpeedometerValue Rte_Write_CtSaSpeedometer_PpSpeedometerValueOut_DeSpeedometerValue
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_PpSpeedometerValueOut_DeSpeedometerValue(IdtDioValueType data)
 *
 *********************************************************************************************************************/
