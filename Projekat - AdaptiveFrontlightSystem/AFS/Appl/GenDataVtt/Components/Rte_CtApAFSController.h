...
extern VAR(IdtDioValueType, RTE_VAR_NOINIT) Rte_CpSaAmbientLight_PpAmbientLightBrightnessOut_DeAmbientLightBrightness; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(IdtDioValueType, RTE_VAR_NOINIT) Rte_CpSaSpeedometer_PpSpeedometerValueOut_DeSpeedometerValue; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Read_CtApAFSController_PpAmbientLightBrightnessIn_DeAmbientLightBrightness(data) (*(data) = Rte_CpSaAmbientLight_PpAmbientLightBrightnessOut_DeAmbientLightBrightness, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_CtApAFSController_PpSpeedometerValueIn_DeSpeedometerValue(data) (*(data) = Rte_CpSaSpeedometer_PpSpeedometerValueOut_DeSpeedometerValue, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, CtApAFSController_CODE) RCtApLowBatteryLogic(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
