...
#  define Rte_Read_CtSaAmbientLight_PpAmbientLightBrightnessIn_DeAmbientLightBrightness(data) ((void)Com_ReceiveSignal(ComConf_ComSignal_sig_AmbientLightBrightness_In, (data)), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, CtSaAmbientLight_CODE) RCtSaAmbientLight(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
