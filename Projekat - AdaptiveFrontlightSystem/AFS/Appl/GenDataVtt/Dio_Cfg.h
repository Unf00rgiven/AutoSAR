 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dio_Cfg.h
 *   Generation Time: 2023-03-07 17:35:20
 ...
 *  GLOBAL DEFINES
 **********************************************************************************************************************/
#define DIO_MAX_CHANNEL_COUNT       (3U)
...
#define DioConf_DioChannel_env_AFSSwitch    ((Dio_ChannelType) 0) 
#define DioConf_DioChannel_env_HighBeamSwitch    ((Dio_ChannelType) 1) 
#define DioConf_DioChannel_env_BatteryLevel    ((Dio_ChannelType) 2) 
