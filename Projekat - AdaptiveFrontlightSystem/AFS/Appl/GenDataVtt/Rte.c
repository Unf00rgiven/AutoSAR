...
VAR(IdtDioValueType, RTE_VAR_NOINIT) Rte_CpSaAmbientLight_PpAmbientLightBrightnessOut_DeAmbientLightBrightness; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
STATIC FUNC(void, RTE_CODE) Rte_IncDisableFlags_CpApBatteryManager_PpBatteryMode_BatteryModes(uint8 nextMode); /* PRQA S 0850 */ /* MD_MSR_19.8 */
STATIC FUNC(void, RTE_CODE) Rte_DecDisableFlags_CpApBatteryManager_PpBatteryMode_BatteryModes(uint8 previousMode); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
STATIC VAR(Rte_ModeInfoType_CpApBatteryManager_PpBatteryMode_BatteryModes, RTE_VAR_NOINIT) Rte_ModeInfo_CpApBatteryManager_PpBatteryMode_BatteryModes;

VAR(uint8, RTE_VAR_NOINIT) Rte_ModeMachine_CpApBatteryManager_PpBatteryMode_BatteryModes; /* PRQA S 3408 */ /* MD_Rte_3408 */
VAR(uint8, RTE_VAR_NOINIT) Rte_ModeMachine_CpApBatteryManager_PpBswMBatteryLevel_BswM_MDGP_MdgBswMBatteryModes; /* PRQA S 3408 */ /* MD_Rte_3408 */
...
CONST(EventMaskType, RTE_CONST) Rte_ModeEntryEventMask_CpApBatteryManager_PpBatteryMode_BatteryModes[3] =
{
  (EventMaskType) 0, /* BATTERY_HIGH */
  Rte_Ev_Run1_CpApAFSController_RCtApLowBatteryLogic, /* BATTERY_LOW */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Start(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_CpSaAmbientLight_PpAmbientLightBrightnessOut_DeAmbientLightBrightness = 0U;
  ...
  Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic = 1U;

  Rte_ModeMachine_BswM_Switch_ESH_ModeSwitch_BswM_MDGP_ESH_Mode = RTE_MODE_ESH_Mode_STARTUP;

  Rte_ModeMachine_CpApBatteryManager_PpBatteryMode_BatteryModes = RTE_TRANSITION_MdgBswMBatteryModes;

  Rte_ModeInfo_CpApBatteryManager_PpBatteryMode_BatteryModes.Rte_ModeQueue[0U] = RTE_MODE_MdgBswMBatteryModes_BATTERY_MEDIUM;
  Rte_ModeInfo_CpApBatteryManager_PpBatteryMode_BatteryModes.Rte_ModeQueue[1U] = RTE_MODE_MdgBswMBatteryModes_BATTERY_MEDIUM;

  Rte_ModeMachine_CpApBatteryManager_PpBswMBatteryLevel_BswM_MDGP_MdgBswMBatteryModes = RTE_MODE_MdgBswMBatteryModes_BATTERY_MEDIUM;
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtSaAmbientLight_PpAmbientLightBrightnessOut_DeAmbientLightBrightness(IdtDioValueType data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  Rte_CpSaAmbientLight_PpAmbientLightBrightnessOut_DeAmbientLightBrightness = *(&data);
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtSaSpeedometer_PpSpeedometerValueOut_DeSpeedometerValue(IdtDioValueType data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  ...
  /* scheduled trigger for runnables: RCtApAFSControllerLogic */
  (void)SetEvent(My_Task, Rte_Ev_Run2_CpApAFSController_RCtApAFSControllerLogic); /* PRQA S 3417 */ /* MD_Rte_Os */
  return ret;
} /* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtSaSteeringWheel_PpSteeringWheelPositionOut_DeSteeringWheelPosition(IdtDioValueType data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  ...
  /* scheduled trigger for runnables: RCtApAFSControllerLogic */
  (void)SetEvent(My_Task, Rte_Ev_Run3_CpApAFSController_RCtApAFSControllerLogic); /* PRQA S 3417 */ /* MD_Rte_Os */
  return ret;
} /* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
STATIC FUNC(void, RTE_CODE) Rte_IncDisableFlags_CpApBatteryManager_PpBatteryMode_BatteryModes(uint8 nextMode) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  if (nextMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_HIGH)
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic < Rte_TriggerDisableMaxCount_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic, RTE_INCDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic++;
  }
  else if (nextMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_LOW) /* PRQA S 2004 */ /* MD_Rte_2004 */
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW < Rte_TriggerDisableMaxCount_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW, RTE_INCDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW++;
  }
  else if (nextMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_MEDIUM) /* PRQA S 2004 */ /* MD_Rte_2004 */
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic < Rte_TriggerDisableMaxCount_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic, RTE_INCDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic++;
  }
...
STATIC FUNC(void, RTE_CODE) Rte_DecDisableFlags_CpApBatteryManager_PpBatteryMode_BatteryModes(uint8 previousMode) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  if (previousMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_HIGH)
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic > 0, RTE_DECDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic--;
  }
  else if (previousMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_LOW) /* PRQA S 2004 */ /* MD_Rte_2004 */
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW > 0, RTE_DECDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW--;
  }
  else if (previousMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_MEDIUM) /* PRQA S 2004 */ /* MD_Rte_2004 */
  {
    Rte_CheckDetErrorContinue(Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic > 0, RTE_DECDISABLEFLAGS_SERVICE_ID, RTE_E_DET_TRIGGERDISABLECOUNTER); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic--;
  }
...
FUNC(uint8, RTE_CODE) Rte_Mode_BswM_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryModes_BswM_MDGP_MdgBswMBatteryModes(void) /* PRQA S 3408 */ /* MD_Rte_3408 */
{
  return Rte_ModeMachine_CpApBatteryManager_PpBswMBatteryLevel_BswM_MDGP_MdgBswMBatteryModes;
}
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_CtApBatteryManager_PpBatteryMode_BatteryModes(uint8 nextMode) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;
  ...
  else if (Rte_ModeMachine_CpApBatteryManager_PpBatteryMode_BatteryModes == RTE_TRANSITION_MdgBswMBatteryModes)
  {
    ret = RTE_E_LIMIT;
    Rte_EnableOSInterrupts(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
  }
  else
  {
    ...
    uint8 currentMode = Rte_ModeMachine_CpApBatteryManager_PpBatteryMode_BatteryModes;

    ModeSwitchEventMask = Rte_ModeEntryEventMask_CpApBatteryManager_PpBatteryMode_BatteryModes[nextMode];

    if ((ModeSwitchEventMask == (EventMaskType)0) && (currentMode != nextMode))
    {
      if ((nextMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_HIGH) || (currentMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_HIGH))
      {
        ModeSwitchEventMask |= Rte_Ev_MS_My_Task;
      }
      else if ((nextMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_LOW) || (currentMode == RTE_MODE_MdgBswMBatteryModes_BATTERY_LOW)) /* PRQA S 2004 */ /* MD_Rte_2004 */
      {
        ModeSwitchEventMask |= Rte_Ev_MS_My_Task;
      }
      else
    ...
    {
      Rte_ModeInfo_CpApBatteryManager_PpBatteryMode_BatteryModes.Rte_ModeQueue[0] = nextMode;
      Rte_ModeInfo_CpApBatteryManager_PpBatteryMode_BatteryModes.Rte_ModeQueue[1U] = currentMode;

      Rte_ModeMachine_CpApBatteryManager_PpBatteryMode_BatteryModes = RTE_TRANSITION_MdgBswMBatteryModes;
      if (currentMode != nextMode)
      {
        Rte_IncDisableFlags_CpApBatteryManager_PpBatteryMode_BatteryModes(nextMode);
      }
      Rte_EnableOSInterrupts(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    ...
    {
      Rte_ModeMachine_CpApBatteryManager_PpBatteryMode_BatteryModes = nextMode;
      Rte_EnableOSInterrupts(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    }
  }
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_CtApBatteryManager_PpBswMBatteryLevel_BswM_MDGP_MdgBswMBatteryModes(uint8 nextMode) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;
  ...
  else
  {
    ...
    Rte_ModeMachine_CpApBatteryManager_PpBswMBatteryLevel_BswM_MDGP_MdgBswMBatteryModes = nextMode;
...
TASK(IO_Task) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  ...
  for(;;)
  {
    ...
    if (((ev & Rte_Ev_Cyclic_IO_Task_0_100ms) != (EventMaskType)0) && (Rte_TriggerDisableFlags.Rte_Trigger_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW == 0))
    {
      /* call runnable */
...
TASK(My_Task) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  ...
  for(;;)
  {
    (void)WaitEvent(Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerLogic | Rte_Ev_Run1_CpApAFSController_RCtApLowBatteryLogic | Rte_Ev_Run2_CpApAFSController_RCtApAFSControllerLogic | Rte_Ev_Run3_CpApAFSController_RCtApAFSControllerLogic | Rte_Ev_MS_My_Task); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(My_Task, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerLogic | Rte_Ev_Run1_CpApAFSController_RCtApLowBatteryLogic | Rte_Ev_Run2_CpApAFSController_RCtApAFSControllerLogic | Rte_Ev_Run3_CpApAFSController_RCtApAFSControllerLogic | Rte_Ev_MS_My_Task)); /* PRQA S 3417 */ /* MD_Rte_Os */

    if ((((ev & Rte_Ev_Run1_CpApAFSController_RCtApAFSControllerLogic) != (EventMaskType)0) && (Rte_TriggerDisableFlags.Rte_Trigger_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW == 0)) || (((ev & Rte_Ev_Run2_CpApAFSController_RCtApAFSControllerLogic) != (EventMaskType)0) && (Rte_TriggerDisableFlags.Rte_Trigger_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW == 0)) || (((ev & Rte_Ev_Run3_CpApAFSController_RCtApAFSControllerLogic) != (EventMaskType)0) && (Rte_TriggerDisableFlags.Rte_Trigger_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW == 0)))
    {
      /* call runnable */
      RCtApAFSControllerLogic();
    }

    if (((ev & Rte_Ev_Run1_CpApAFSController_RCtApLowBatteryLogic) != (EventMaskType)0) && (Rte_TriggerDisableFlags.Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic == 0))
    {
      /* call runnable */
      RCtApLowBatteryLogic();
    }

    if (((ev & Rte_Ev_Run1_CpApAFSController_RCtApLowBatteryLogic) != (EventMaskType)0) || ((ev & Rte_Ev_MS_My_Task) != (EventMaskType)0))
    {
      uint8 previousMode;
      uint8 nextMode;

      Rte_CheckDetErrorContinue(Rte_ModeMachine_CpApBatteryManager_PpBatteryMode_BatteryModes == RTE_TRANSITION_MdgBswMBatteryModes, RTE_TASK_SERVICE_ID, RTE_E_DET_TRANSITIONSTATE); /* PRQA S 3109 */ /* MD_MSR_14.3 */

      Rte_DisableOSInterrupts(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
      previousMode = Rte_ModeInfo_CpApBatteryManager_PpBatteryMode_BatteryModes.Rte_ModeQueue[1U];
      nextMode = Rte_ModeInfo_CpApBatteryManager_PpBatteryMode_BatteryModes.Rte_ModeQueue[0];

      if (previousMode != nextMode)
      {
        Rte_DecDisableFlags_CpApBatteryManager_PpBatteryMode_BatteryModes(previousMode);
      }

      Rte_ModeMachine_CpApBatteryManager_PpBatteryMode_BatteryModes = Rte_ModeInfo_CpApBatteryManager_PpBatteryMode_BatteryModes.Rte_ModeQueue[0];
