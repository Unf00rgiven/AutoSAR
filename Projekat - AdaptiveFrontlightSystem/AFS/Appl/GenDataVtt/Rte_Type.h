...
# define Rte_TypeDef_BswM_MdgBswMBatteryModes
typedef uint8 BswM_MdgBswMBatteryModes;
...
#  define Rte_TypeDef_IdtAmbientLightBrightness
typedef uint8 IdtAmbientLightBrightness;

#  define Rte_TypeDef_IdtBatteryLevel
typedef uint8 IdtBatteryLevel;

#  define Rte_TypeDef_IdtSpeedometerValue
typedef uint8 IdtSpeedometerValue;
...
extern VAR(IdtDioValueType, RTE_VAR_NOINIT) Rte_CpSaAmbientLight_PpAmbientLightBrightnessOut_DeAmbientLightBrightness; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
extern VAR(IdtDioValueType, RTE_VAR_NOINIT) Rte_CpSaSpeedometer_PpSpeedometerValueOut_DeSpeedometerValue; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
typedef struct
{
  uint8 Rte_Trigger_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW;
  uint8 Rte_Trigger_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic;
...
#  define Rte_TriggerDisableMaxCount_CpApBatteryManager_PpBatteryMode_BatteryModes_BATTERY_LOW 1
#  define Rte_TriggerDisableMaxCount_My_Task_Rte_Trigger1_CpApAFSController_RCtApLowBatteryLogic 2

#  define RTE_START_SEC_CONST_UNSPECIFIED
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

extern CONST(EventMaskType, RTE_CONST) Rte_ModeEntryEventMask_CpApBatteryManager_PpBatteryMode_BatteryModes[3];
...
} Rte_ModeInfoType_CpApBatteryManager_PpBatteryMode_BatteryModes;
