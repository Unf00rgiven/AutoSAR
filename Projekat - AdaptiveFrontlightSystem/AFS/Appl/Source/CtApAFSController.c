 ...
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered on DataReceivedEvent for DataElementPrototype <DeAmbientLightBrightness> of PortPrototype <PpAmbientLightBrightnessIn>
 *     and not in Mode(s) <BATTERY_LOW>
 *   - triggered on DataReceivedEvent for DataElementPrototype <DeSpeedometerValue> of PortPrototype <PpSpeedometerValueIn>
 *     and not in Mode(s) <BATTERY_LOW>
 ...
 *   Std_ReturnType Rte_Read_PpSpeedometerValueIn_DeSpeedometerValue(IdtDioValueType *data)
 ...
 *********************************************************************************************************************/
	...
	uint8 ambientLightBrightness;
	uint8 speedometerValue;

	/* Read data from CAN bus */
	/* TODO */
	(void)Rte_Read_PpAmbientLightBrightnessIn_DeAmbientLightBrightness(&ambientLightBrightness);
	(void)Rte_Read_PpSpeedometerValueIn_DeSpeedometerValue(&speedometerValue);
	(void)Rte_Read_PpSteeringWheelPosition_DeSteeringWheelPosition(&steeringWheelPosition);
	...
	if (FALSE == highBeamModeSwitchState)
	{
		...
		/* TODO */
		if (ambientLightBrightness <= AMBIENT_LIGHT_TRESHOLD)
		{
			// CITY MODE
			if (speedometerValue < 50)
			{
				leftLightLength = CITYMODE_LENGTH_LEFT;
				rightLightLength = CITYMODE_LENGTH_RIGHT;
			}
			else if (speedometerValue < 120)
			{
				/* COUNTRYMODE */
				/* TODO */
				...
				{
					leftLightLength = COUNTRYMODE_LENGTH_RIGHT;
					rightLightLength = COUNTRYMODE_LENGTH_LEFT;
				}
			}
			else
			{
				...
				{
					leftLightLength = MOTORWAYMODE_LENGTH_RIGHT;
					rightLightLength = MOTORWAYMODE_LENGTH_LEFT;
				}
			}
		}
		else
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: RCtApLowBatteryLogic
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered on entering of Mode <BATTERY_LOW> of ModeDeclarationGroupPrototype <BatteryModes> of PortPrototype <PpBatterModeIn>
 *     and not in Mode(s) <BATTERY_HIGH, BATTERY_MEDIUM>
 *
 **********************************************************************************************************************
 *
 * Output Interfaces:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RCtApLowBatteryLogic_doc
 *********************************************************************************************************************/
...
FUNC(void, CtApAFSController_CODE) RCtApLowBatteryLogic(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: RCtApLowBatteryLogic
 *********************************************************************************************************************/
	uint8 highBeamModeSwitchState;
	(void)Rte_Call_PpHighBeam_ReadChannel(&highBeamModeSwitchState);
	if (highBeamModeSwitchState == TRUE)
	{
		/* Provide data about light length to Actuator SWC */
...
#if 0
/***  Start of saved code (symbol: documentation area:RCtApReadBatteryMode_doc)  ****************************/
...
#if 0
/***  Start of saved code (symbol: runnable implementation:RCtApReadBatteryMode)  ***************************/
