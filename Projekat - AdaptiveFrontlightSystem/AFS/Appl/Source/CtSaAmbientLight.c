 ...
 *
 *   Description:  C-Code implementation template for SW-C <CtSaAmbientLight>
 *********************************************************************************************************************/
 ...
 * Symbol: RCtSaAmbientLight
 *********************************************************************************************************************/
	uint8 ambientLightBrightness;
	Rte_Read_PpAmbientLightBrightnessIn_DeAmbientLightBrightness(&ambientLightBrightness);
	Rte_Write_PpAmbientLightBrightnessOut_DeAmbientLightBrightness(ambientLightBrightness);
