 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Cfg.h
 *   Generation Time: 2021-04-23 16:27:48
...
#define COM_EQ2_RXACCESSINFOINDENDIDXOFRXPDUINFO                      5U
...
#define COM_EQ2_RXSIGINFOENDIDXOFRXPDUINFO                            5U
...
#define ComConf_ComSignal_sig_AFSSwitch_In                          0
#define ComConf_ComSignal_sig_AmbientLightBrightness_In             1
#define ComConf_ComSignal_sig_CurrentSpeedSlider_In                 2
#define ComConf_ComSignal_sig_HighBeamSwitch_In                     3
#define ComConf_ComSignal_sig_SteeringWheelPosition_In              4
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_sig_LeftHAngle_Out                        0
#define ComConf_ComSignal_sig_LeftLightLength_Out                   1
#define ComConf_ComSignal_sig_RightHAngle_Out                       2
#define ComConf_ComSignal_sig_RightLightLength_Out                  3
/**\} */
...
/** 
  ...
  \{
*/ 
#define Com_GetAllSigCntOfPCConfig()                                  9UL
...
#define Com_GetSizeOfRxSigBufferXInt8OfPCConfig()                     5U  /**< the number of accomplishable value elements in Com_RxSigBufferXInt8 */
...
#define Com_GetApplTypeOfRxAccessInfo(Index)                          Com_GetBusAccOfRxAccessInfo(Index)  /**< Application data type. ea:{{E33B4863-9456-4cd2-84A1-94C89AF37A23}} */
...
#define Com_GetByteLengthOfRxAccessInfo(Index)                        Com_GetBusAccOfRxAccessInfo(Index)  /**< Byte length of the signal or group signal. ea:{{646B1706-21D2-4b10-A5AC-A1113F297CD1}} */
...
#define Com_GetRxAccessInfoIndEndIdxOfRxPduInfo(Index)                5U  /**< the end index of the 0:n relation pointing to Com_RxAccessInfoInd */
...
#define Com_GetRxSigInfoEndIdxOfRxPduInfo(Index)                      5U  /**< the end index of the 0:n relation pointing to Com_RxSigInfo */
...
{
  Com_RxSigBufferXInt8Type sig_AFSSwitch_In[1];
  Com_RxSigBufferXInt8Type sig_AmbientLightBrightness_In[1];
  Com_RxSigBufferXInt8Type sig_CurrentSpeedSlider_In[1];
  Com_RxSigBufferXInt8Type sig_HighBeamSwitch_In[1];
  Com_RxSigBufferXInt8Type sig_SteeringWheelPosition_In[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  Com_RxSigBufferXInt8Type raw[5];
