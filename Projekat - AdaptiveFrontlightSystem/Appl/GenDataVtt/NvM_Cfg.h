 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: NvM_Cfg.h
 *   Generation Time: 2019-12-04 14:52:23
...
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock1 (5UL) 
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock2 (6UL) 
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock3 (7UL) 
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock4 (8UL) 
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock5 (9UL) 
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock6 (10UL) 
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock7 (11UL) 


/* number of defined NV blocks */
#define NVM_TOTAL_NUM_OF_NVRAM_BLOCKS    (12UL)
