...
FUNC(Std_ReturnType, RTE_CODE) Rte_Start(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  /* activate the alarms used for TimingEvents */
  (void)SetRelAlarm(Rte_Al_TE_CpSaSteeringWheel_RCtSaSteeringWheelGetPosition, RTE_MSEC_SystemTimer(0) + (TickType)1, RTE_MSEC_SystemTimer(100)); /* PRQA S 3417 */ /* MD_Rte_Os */
...
{
  /* deactivate alarms */
  (void)CancelAlarm(Rte_Al_TE_CpSaSteeringWheel_RCtSaSteeringWheelGetPosition); /* PRQA S 3417 */ /* MD_Rte_Os */
...
TASK(IO_Task) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  ...
  for(;;)
  {
    (void)WaitEvent(Rte_Ev_Run_CpSaLeftFrontlight_RCtSaFrontlight | Rte_Ev_Run_CpSaRightFrontlight_RCtSaFrontlight | Rte_Ev_Run_CpSaSteeringWheel_RCtSaSteeringWheelGetPosition); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(IO_Task, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_Run_CpSaLeftFrontlight_RCtSaFrontlight | Rte_Ev_Run_CpSaRightFrontlight_RCtSaFrontlight | Rte_Ev_Run_CpSaSteeringWheel_RCtSaSteeringWheelGetPosition)); /* PRQA S 3417 */ /* MD_Rte_Os */

    if ((ev & Rte_Ev_Run_CpSaSteeringWheel_RCtSaSteeringWheelGetPosition) != (EventMaskType)0)
    {
      /* call runnable */
...
TASK(My_Task) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  ...
  for(;;)
  {
    (void)WaitEvent(Rte_Ev_Run_CpApAFSController_RCtApAFSControllerLogic); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(My_Task, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_Run_CpApAFSController_RCtApAFSControllerLogic)); /* PRQA S 3417 */ /* MD_Rte_Os */
